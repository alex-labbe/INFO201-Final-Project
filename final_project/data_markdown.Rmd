...
The first correlation we wanted to further explore was how a states temperature was affecting its collision rate. We graphed the same relationship above, but colored the states by temperature
```{r}
