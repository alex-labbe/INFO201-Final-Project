...
```{r}
ggplot(drivers, aes(AverageTemperatureAvgHighF, `Number of drivers involved in fatal collisions per billion miles`)) + geom_point()
```
```{r}
ggplot(drivers, aes(AverageTemperatureAvgLowF, `Number of drivers involved in fatal collisions per billion miles`)) + geom_point()
```


collisions VS education data
